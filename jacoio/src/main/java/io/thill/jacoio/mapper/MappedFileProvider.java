...
/**
 * An interface to provide pre-mapped files for {@link RollingConcurrentFile}
 *
 * @author Eric Thill
 */
@FunctionalInterface
interface MappedFileProvider extends AutoCloseable {
  MappedConcurrentFile nextFile() throws IOException;
